 ...
 */
if ( !function_exists('wp960_theme_options_init') ) {
	function wp960_theme_options_init(){
		register_setting( 'wp960_options', 'wp960_theme_options', 'wp960_theme_options_validate' );
	}
}
 ...
 */
if ( !function_exists('wp960_theme_options_add_page') ) {
	function wp960_theme_options_add_page() {
		add_theme_page( __( 'WordPress 960 Theme Options', 'wp960' ), __( '960 Theme Options', 'wp960' ), 'edit_theme_options', 'wp960_theme_options', 'wp960_theme_options_do_page' );
	}
}
 ...
 */
if ( !function_exists('wp960_theme_options_do_page') ) {
	function wp960_theme_options_do_page() {
		...
		?>
		<div class="wrap">
			<?php screen_icon(); echo "<h2>" . __( 'WordPress 960 Theme Options', 'wp960' ) . "</h2>"; ?>
 ...
 */
if ( !function_exists('wp960_theme_options_validate') ) {
	function wp960_theme_options_validate( $input ) {
...
add_action( 'admin_init', 'wp960_theme_options_init' );
add_action( 'admin_menu', 'wp960_theme_options_add_page' );
