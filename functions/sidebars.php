...
if ( !function_exists('register_cp_sidebars') ) {
	function register_cp_sidebars() {
		...
		register_sidebar(array('name' => 'Right Sidebar','before_widget' => '<div class="wp960-sidebar-widget %2$s">','after_widget' => '</div>','before_title' => '<h2 class="widget-title">','after_title' => '</h2>'));
